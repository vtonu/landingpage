...
const FeatureSection = () => {
  return (
    <div className="relative mt-20 border-b border-blue-700 min-h-[600px]">
      <h2 className="mt-6 text-3xl tracking-wide text-center border-t border-blue-700 sm:text-5xl lg:text-6xl">
        <br></br> <br></br>
        OUR{' '}
        ...
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
            <div className="grid gap-4 justify-items-center">
              ...
              <div className="flex items-center justify-center w-10 h-10 text-blue-700 rounded-sm bg-neutral-100">
                {feature.icon}
              </div>
